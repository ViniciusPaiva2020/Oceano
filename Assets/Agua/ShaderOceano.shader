		...
		SubShader
		{
			...
			Pass
			{
				...
				half4 frag(Varyings Input) :SV_TARGET
				{
				   ...
				   half4 normalmap = _NormalTex.Sample(sampler_NormalTex, half2(_Time.x + Input.uvVAR.x, Input.uvVAR.y + wiggle)) * 2 - 1;
				   half4 normalmap2 = _NormalTex.Sample(sampler_NormalTex, half2(Input.uvVAR.x, _Time.x + Input.uvVAR.y + wiggle)) * 2 - 1;
